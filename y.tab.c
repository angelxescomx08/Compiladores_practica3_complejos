...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "'*'", "'/'", "UNARYMINUS", "'^'", "'\\n'", "'i'", "'('",
  "')'", "$accept", "list", "asgn", "complejo", "expr", YY_NULLPTR
};
#endif
...
{
     -13,     0,   -13,   -12,    12,     4,    -3,    28,   -13,     3,
       8,   -13,    39,   -13,    32,    38,     3,     3,    25,   -13,
      19,   -13,     3,     3,     3,     3,    40,   -13,    30,    36,
      46,    29,    41,    55,   -13,    50,    50,     2,     2,   -13,
     -13,   -13,   -13,    47,    49,   -13,   -13
};
...
{
       2,     0,     1,     0,     0,    13,     0,     0,     3,     0,
      14,    12,     0,     6,     0,     0,     0,     0,     0,    14,
       0,     4,     0,     0,     0,     0,     0,     5,     0,     0,
       7,     0,     0,     0,    21,    16,    17,    18,    19,    20,
       8,     9,    15,     0,     0,    10,    11
};
...
{
       2,     3,    13,     4,     5,     6,     4,     5,     6,     7,
      20,    16,     7,    17,     8,    26,     9,    30,    31,     9,
      14,    15,    21,    35,    36,    37,    38,    22,    23,    24,
      25,    18,    26,    32,    33,    28,    34,    22,    23,    24,
      25,    29,    26,    39,    43,    40,    42,    22,    23,    24,
      25,    41,    26,    27,    22,    23,    24,    25,    44,    26,
      24,    25,    45,    26,    46,    10
};

static const yytype_uint8 yycheck[] =
{
       0,     1,    14,     3,     4,     5,     3,     4,     5,     9,
       9,     7,     9,    16,    14,    13,    16,    16,    17,    16,
       8,     9,    14,    22,    23,    24,    25,     8,     9,    10,
      11,     3,    13,     8,     9,     3,    17,     8,     9,    10,
      11,     3,    13,     3,     3,    15,    17,     8,     9,    10,
      11,    15,    13,    14,     8,     9,    10,    11,     3,    13,
      10,    11,    15,    13,    15,     1
};
...
{
       0,    19,     0,     1,     3,     4,     5,     9,    14,    16,
      20,    21,    22,    14,     8,     9,     7,    16,     3,    20,
      22,    14,     8,     9,    10,    11,    13,    14,     3,     3,
      22,    22,     8,     9,    17,    22,    22,    22,    22,     3,
      15,    15,    17,     3,     3,    15,    15
};
...
#line 44 "hoc3.y" /* yacc.c:1646  */
    {(yyval.val)=creaComplejo((yyvsp[-3].num),(yyvsp[-1].num));}
...
#line 56 "hoc3.y" /* yacc.c:1646  */
    {(yyval.val) = Complejo_add((yyvsp[-2].val),(yyvsp[0].val));}
#line 1319 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 57 "hoc3.y" /* yacc.c:1646  */
    {(yyval.val) = Complejo_sub((yyvsp[-2].val),(yyvsp[0].val));}
#line 1325 "y.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 58 "hoc3.y" /* yacc.c:1646  */
    {(yyval.val) = Complejo_mul((yyvsp[-2].val),(yyvsp[0].val));}
#line 1331 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 59 "hoc3.y" /* yacc.c:1646  */
    {(yyval.val) = Complejo_div((yyvsp[-2].val),(yyvsp[0].val));}
#line 1337 "y.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 60 "hoc3.y" /* yacc.c:1646  */
    { (yyval.val)=Complejo_pow((yyvsp[-2].val), (yyvsp[0].num));}
#line 1343 "y.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 61 "hoc3.y" /* yacc.c:1646  */
